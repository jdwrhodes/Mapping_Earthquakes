...
// Creaate a legend control object
...
legend.onAdd = function () {
    ...
    var div = L.DomUtil.create('div', 'info legend'), //this creates a new div element with the name 'info legend' on the DOM, or in this case, the index.html
    ...
    for (var i = 0; i < magnitudes.length; i++) {
        div.innerHTML += //innerHTML is the actual text that is being rendered on the page
            '<i style="background:' + colors[i] + '"></i> ' +
            magnitudes[i] + (magnitudes[i + 1] ? '&ndash;' + magnitudes[i + 1] + '<br>' : '+');
    }       // the code above is using an One line if statement, marked by the "?" and the ":"
